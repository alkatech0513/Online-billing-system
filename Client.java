...
public class Client extends JFrame implements ActionListener {
    ...
    Client(){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icon/2.png"));
        ...
        ImageIcon i11 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icon/phone.png"));
        ...
        ImageIcon i14 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icon/3icon.png"));
        Image i15 =  i14.getImage().getScaledInstance(13, 30 ,Image.SCALE_DEFAULT);
